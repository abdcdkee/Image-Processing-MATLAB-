function center = center_objects(label)
    ...
    for i=1:count-1
        label(floor(centroid(2,i)), floor(centroid(1,i))) = 255;

        label(floor(centroid(2,i))+1, floor(centroid(1,i))) = 255;
        label(floor(centroid(2,i))+1, floor(centroid(1,i))+1) = 255;
        label(floor(centroid(2,i)), floor(centroid(1,i))+1) = 255;
        label(floor(centroid(2,i)-1), floor(centroid(1,i))-1) = 255;
        label(floor(centroid(2,i)), floor(centroid(1,i))-1) = 255;
        label(floor(centroid(2,i)-1), floor(centroid(1,i))) = 255;
        label(floor(centroid(2,i)-1), floor(centroid(1,i))+1) = 255;
